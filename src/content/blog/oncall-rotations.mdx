---
title: "The 9-Hour On-Call Nightmare: Why Responsibility Without Authority Burns Out Teams"
description: "Spending 9 hours 'on-call' mostly waiting for other teams to respond taught me a harsh lesson: the most exhausting part of on-call isn't technical problems—it's having responsibility without authority. This is the story of how we transformed from a 'passive waiting team' to owning our systems, reducing support staff from 10 to 3 people while handling 50% more deployments. Includes practical lessons on making on-call sustainable and why system ownership matters more than process optimization."
tags: ["on-call", "developer-experience", "infrastructure", "operations", "burnout", "problem-solving", "system-ownership"]
date: "2024-09-14"
---
